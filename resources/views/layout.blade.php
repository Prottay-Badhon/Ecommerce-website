...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01703512032</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> prottaybadhon54@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="http://www.intagram.com"><i class="fa fa-instagram"></i></a></li>
                  ...
                  <li><a href="#">Pakistan</a></li>
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="#">Indian Rupese</a></li>
                  <li><a href="#">Pak Rupese</a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{ URL::to('/checkoutLogin') }}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="{{ URL::to('/display-cart') }}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                @if(Session::get('logged_in'))
								<li><a href="{{ URL::to('/logout')}}"><i class="fa fa-lock"></i> Logout</a></li>
                @else
                 <li><a href="{{ URL::to('/loginPage')}}"><i class="fa fa-lock"></i> login</a></li>
                 @endif
                 <li><a href="{{ URL::to('/admin')}}"><i class="fa fa-unlock-alt"></i> Admin login</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{ URL::to('/display-cart') }}">Cart</a></li>
                                    </ul>
                                </li>
								<li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{ URL::to('/blog')}}">Our Blog</a></li>
  ...
  <section id="slider" class="mt-5"><!--slider-->
    @yield('slider')
 </section>
                 ...
                 foreach ($category as $row) { ?>
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-parent="#accordian" href="{{ URL::to('/productByCategory'.$row->id) }}">
                  ...
                  <?php
                   $band = DB::table('tbl_manufacture')->where('publication_status',1)->get();
                   foreach ($band as $row) { ?>
									<li><a href="{{URL::to('/productByManufacture'.$row->manufacture_id) }}"> <span class="pull-right">(50)</span>{{ $row->manufacture_name}}</a></li>
                <?php } ?>
								</ul>
							</div>
						</div><!--/brands_products-->
